...
'New:
'test delete and recreate ftp
'ftp create folder and files
'service watch and reload config file
'no ext with dot in main part of name
'delay on start
'unc creds
'the service ignores completely the RunCopy setting
